namespace PanoClient
{
    ...
    {				
        ...
        public CustomProperty(string strName, string strDisplayName, object objValue, bool boolIsReadOnly, string strCategory, string strDescription, bool boolVisible)
            :this(strName, strDisplayName, objValue, boolIsReadOnly, strCategory, strDescription, boolVisible, 100)
        {
        }
		public CustomProperty(string strName, string strDisplayName, object objValue, bool boolIsReadOnly, string strCategory, string strDescription, bool boolVisible, int intOrder)
		{
			sName = strName;
            sDisplayName = strDisplayName;
			oValue = objValue;
        ...
        public CustomProperty(string strName, string strDisplayName, ref object objRef, string strProp, bool boolIsReadOnly, string strCategory, string strDescription, bool boolVisible)
            : this(strName, strDisplayName, ref objRef, strProp, boolIsReadOnly, strCategory, strDescription, boolVisible, 100)
        {
        }
        public CustomProperty(string strName, string strDisplayName, ref object objRef, string strProp, bool boolIsReadOnly, string strCategory, string strDescription, bool boolVisible, int intOrder)
		{
			sName = strName;
            sDisplayName = strDisplayName;
			bIsReadOnly = boolIsReadOnly;
        ...
        [Category("Appearance"), DisplayName("Name"), DescriptionAttribute("Name of the CustomProperty."), ParenthesizePropertyName(true), XmlElementAttribute("Name")]public string Name
        {
			get
			{
				return sName;
        ...
        [Category("Appearance"), DisplayName("DisplayName"), DescriptionAttribute("Display Name of the CustomProperty."), ParenthesizePropertyName(true), XmlElementAttribute("DisplayName")]
        ...
        [Category("Order"), DescriptionAttribute("Property order for sort."), XmlElementAttribute(IsNullable = true), DefaultValue(false)]public int Order
        {
            get
            {
                return iOrder;
		...
		public class CustomPropertyDescriptor : PropertyDescriptor
		{
			...
			public override string DisplayName
			{
				get
				{
                    return string.IsNullOrEmpty(oCustomProperty.DisplayName) ? oCustomProperty.Name : oCustomProperty.DisplayName;
				}
			}
