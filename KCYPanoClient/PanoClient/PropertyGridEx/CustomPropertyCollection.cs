namespace PanoClient
{
	...
	[Serializable()]public class CustomPropertyCollection : System.Collections.CollectionBase, ICustomTypeDescriptor
	{
        ...
        // 
        public virtual int Add(string strName, string strDisplayName, object objValue, bool boolIsReadOnly, string strCategory, string strDescription, bool boolVisible, int intOrder)
        {
            return base.List.Add(new CustomProperty(strName, strDisplayName, objValue, boolIsReadOnly, strCategory, strDescription, boolVisible, intOrder));
        }

        public virtual int Add(string strName, string strDisplayName, ref object objRef, string strProp, bool boolIsReadOnly, string strCategory, string strDescription, bool boolVisible, int intOrder)
        {
            return base.List.Add(new CustomProperty(strName, strDisplayName, ref objRef, strProp, boolIsReadOnly, strCategory, strDescription, boolVisible, intOrder));
        }
		...
		public System.ComponentModel.PropertyDescriptorCollection GetProperties(System.Attribute[] attributes)
		{
			...
			foreach (CustomProperty tempLoopVar_CustomProp in base.List)
			{
				...
				{
                    orderedProperties.Add(new PropertyOrderPair(CustomProp.Name, CustomProp.Order));
                    ...
                    //if (CustomProp.Type == typeof(System.Drawing.PointF)) {
                    //    attrs.Add(new TypeConverterAttribute(typeof(PointFConverter)));
                    //}
            ...
            //string[] names = new string[orderedProperties.Count];
            //for (int i = 0; i < orderedProperties.Count; i++) {
            //    names[i] = ((PropertyOrderPair)orderedProperties[i]).Name;
            //}
