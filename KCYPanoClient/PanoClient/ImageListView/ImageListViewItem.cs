...
namespace PanoClient.ImageListView
{
    ...
    public class ImageListViewItem : ICloneable
    {
        ...
        /// </summary>
        [Category("Appearance"), Browsable(false), Description("Gets or sets the text associated with this item. If left blank, item Text reverts to the name of the image file.")]
        public string Text
        {
            get
            {
        ...
        /// </summary>        
        [Category("File Properties"), Browsable(false), Description("Gets or sets the name of the image file represented by this item.")]
        ...
        /// </summary>
        [Category("File Properties"), Browsable(false), Description("Gets the last access date of the image file represented by this item.")]
        ...
        /// </summary>
        [Category("File Properties"), Browsable(false), Description("Gets the creation date of the image file represented by this item.")]
        ...
        /// </summary>
        [Category("File Properties"), Browsable(false), Description("Gets the modification date of the image file represented by this item.")]
        ...
        /// </summary>
        [Category("File Properties"), Browsable(false), Description("Gets the shell type of the image file represented by this item.")]
        public string FileType { get { UpdateFileInfo(); return mFileType; } }
        /// <summary>
        /// Gets the path of the image file represented by this item.
        /// </summary>        
        [Category("File Properties"), Browsable(false), Description("Gets the path of the image file represented by this item.")]
        public string FilePath { get { UpdateFileInfo(); return mFilePath; } }
        /// <summary>
        /// Gets the name of the folder represented by this item.
        /// </summary>        
        [Category("File Properties"), Browsable(false), Description(" Gets the name of the folder represented by this item.")]
        public string FolderName { get { UpdateFileInfo(); return mFolderName; } }
        /// <summary>
        /// Gets file size in bytes.
        /// </summary>
        [Category("File Properties"), Browsable(false), Description("Gets file size in bytes.")]
        public long FileSize { get { UpdateFileInfo(); return mFileSize; } }
        #endregion

        #region 自定义全景属性
        private string _panoName = "";
        private DateTime _panoDate = DateTime.MinValue;
        ...
        /// 全景分类
        /// </summary>
        [Category("全景属性"), Browsable(true), Description("全景分类."), DisplayName("B.分类"),
        TypeConverter(typeof(ComboxConverter)), ListAttribute(new string[] { "高空全景", "河面全景", "路口", "其他" })]
        public string PanoCategory
        {
            get { return _panoCategory; }
            set { _panoCategory = value; }
        }
        /// <summary>
        /// 拍摄日期
        /// </summary>
        ...
        public DateTime PanoDate {
            get {
                UpdateFileInfo();
                if (_panoDate == DateTime.MinValue) _panoDate = new DateTime(mDateModified.Year, mDateModified.Month, mDateModified.Day);
                return _panoDate;
            }
            set { _panoDate = value; }
        }
        ...
        /// 全景纬度.
        /// </summary>
        [Category("全景属性"), Browsable(true), Description("全景点纬度."), DisplayName("D.纬度")]
        public double PanoLat
        {
            get { return _panoLat; }
            set { _panoLat = value; }
        }
        ...
        /// 全景经度.
        /// </summary>
        [Category("全景属性"), Browsable(true), Description("全景点经度."), DisplayName("E.经度")]
        public double PanoLng
        {
            get { return _panoLng; }
            set { _panoLng = value; }
        }
        ...
        /// 全景角度.
        /// </summary>
        [Category("全景属性"), Browsable(true), Description("全景起始角度.正北为0."), DisplayName("F.朝向")]
        public int PanoHeading
        {
            get { return _panoHeading; }
        ...
        /// Gets image dimensions.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets image dimensions.")]
        public Size Dimensions { get { UpdateFileInfo(); return mDimensions; } }
        /// <summary>
        /// Gets image resolution in pixels per inch.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets image resolution in pixels per inch.")]
        public SizeF Resolution { get { UpdateFileInfo(); return mResolution; } }
        /// <summary>
        /// Gets image description.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets image description.")]
        public string ImageDescription { get { UpdateFileInfo(); return mImageDescription; } }
        /// <summary>
        /// Gets the camera model.
        /// </summary>
        [Category("Camera Properties"), Browsable(false), Description("Gets the camera model.")]
        public string EquipmentModel { get { UpdateFileInfo(); return mEquipmentModel; } }
        /// <summary>
        /// Gets the date and time the image was taken.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets the date and time the image was taken.")]
        public DateTime DateTaken { get { UpdateFileInfo(); return mDateTaken; } }
        /// <summary>
        /// Gets the name of the artist.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets the name of the artist.")]
        public string Artist { get { UpdateFileInfo(); return mArtist; } }
        /// <summary>
        /// Gets image copyright information.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets image copyright information.")]
        public string Copyright { get { UpdateFileInfo(); return mCopyright; } }
        /// <summary>
        /// Gets the exposure time in seconds.
        /// </summary>
        [Category("Camera Properties"), Browsable(false), Description("Gets the exposure time in seconds.")]
        public float ExposureTime { get { UpdateFileInfo(); return mExposureTime; } }
        /// <summary>
        /// Gets the F number.
        /// </summary>
        [Category("Camera Properties"), Browsable(false), Description("Gets the F number.")]
        public float FNumber { get { UpdateFileInfo(); return mFNumber; } }
        /// <summary>
        /// Gets the ISO speed.
        /// </summary>
        [Category("Camera Properties"), Browsable(false), Description("Gets the ISO speed.")]
        public ushort ISOSpeed { get { UpdateFileInfo(); return mISOSpeed; } }
        /// <summary>
        /// Gets user comments.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets user comments.")]
        public string UserComment { get { UpdateFileInfo(); return mUserComment; } }
        /// <summary>
        /// Gets rating in percent between 0-99 (Windows specific).
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets rating in percent between 0-99.")]
        public ushort Rating { get { UpdateFileInfo(); return mRating; } }
        /// <summary>
        /// Gets the star rating between 0-5 (Windows specific).
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets the star rating between 0-5.")]
        public ushort StarRating { get { UpdateFileInfo(); return mStarRating; } }
        /// <summary>
        /// Gets the name of the application that created this file.
        /// </summary>
        [Category("Image Properties"), Browsable(false), Description("Gets the name of the application that created this file.")]
        public string Software { get { UpdateFileInfo(); return mSoftware; } }
        /// <summary>
        /// Gets focal length of the lens in millimeters.
        /// </summary>
        [Category("Camera Properties"), Browsable(false), Description("Gets focal length of the lens in millimeters.")]
