...
{
    /// <summary>
    /// The PanoClient.ImageListView namespace contains new and
    ...
    public partial class ImageListView : Control, IComponent
    {
        ...
        public ImageListView()
        {
            ...
            resources = new ResourceManager("PanoClient.ImageListView.ImageListViewResources", typeof(ImageListView).Assembly);
