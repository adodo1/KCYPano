...
namespace PanoClient.ImageListView
{
    ...
    public static partial class ImageListViewRenderers
    {
        ...
        public class TilesRenderer : ImageListView.ImageListViewRenderer
        {
            ...
            /// <returns>The item size.</returns>
            public override Size MeasureItem(PanoClient.ImageListView.View view)
            {
                if (view == PanoClient.ImageListView.View.Thumbnails)
                {
            ...
            public override void DrawItem(Graphics g, ImageListViewItem item, ItemState state, Rectangle bounds)
            {
                if (ImageListView.View == PanoClient.ImageListView.View.Thumbnails)
                {
                    Size itemPadding = new Size(4, 4);
        ...
        public class XPRenderer : ImageListView.ImageListViewRenderer
        {
            ...
            public override Size MeasureItem(PanoClient.ImageListView.View view)
            {
                ...
                if (view == PanoClient.ImageListView.View.Details)
                    return base.MeasureItem(view);
                else
                {
                    // Calculate item size
            ...
            public override void DrawItem(System.Drawing.Graphics g, ImageListViewItem item, ItemState state, System.Drawing.Rectangle bounds)
            {
                ...
                if (ImageListView.View != PanoClient.ImageListView.View.Details)
                {
                    Size itemPadding = new Size(4, 4);
                ...
                else // if (ImageListView.View == PanoClient.ImageListView.View.Details)
                {
                    if (ImageListView.Focused && ((state & ItemState.Selected) != ItemState.None))
                    {
        ...
        public class ZoomingRenderer : ImageListView.ImageListViewRenderer
        {
            ...
            public override void DrawItem(Graphics g, ImageListViewItem item, ItemState state, Rectangle bounds)
            {
                Clip = (ImageListView.View == PanoClient.ImageListView.View.Details);
