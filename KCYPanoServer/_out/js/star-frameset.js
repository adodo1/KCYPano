...
(function($) {
    ...
    var rowLineCss = 'position:absolute;overflow:hidden;height:4px;border-top:1px solid #d7d7d7;border-bottom:1px solid #d7d7d7;background:#f8f8f8;cursor:n-resize;z-index: 9999',
        colLineCss = 'position:absolute;overflow:hidden;width:60px;border-left:1px solid #d7d7d7;border-right:1px solid #d7d7d7;background:#f8f8f8;cursor:e-resize;z-index: 9999';
    var margin = 3;
    ...
    StarFrameset.prototype = {
        ...
        renderColLine: function(line) {
            ...
            // DoDo Flash页面会干扰响应所以宽度设置为250
            line.css({
                'left': (left + frame.outerWidth() - 250) + 'px',
                'height': '19px',
                'border-radius': '5px',
                'bottom': '0px'
            });
